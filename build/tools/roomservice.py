...
custom_local_manifest = ".repo/local_manifests/cloud.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', '11')
custom_dependencies = "aosp.dependencies"
org_manifest = "cloud-devices"  # leave empty if org is provided in manifest
org_display = "Cloud-Devices"  # needed for displaying
